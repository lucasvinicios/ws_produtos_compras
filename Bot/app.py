...
# produtos = ["Arroz 5kg", "Feijão 1kg", "Macarrão Espaguete 500g", "Óleo de Soja 900ml", "Açúcar Cristal 5kg", "Leite Integral 1L"]

# supermercados = ["Tauste", "Barbosa", "Confiança", "Mercado Livre", "Coop Supermercado", "Tenda Atacado"]
